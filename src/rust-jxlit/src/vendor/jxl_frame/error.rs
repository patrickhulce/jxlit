...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-frame/src/error.rs
...
pub enum Error {
    ...
    VarDct(crate::vendor::jxl_vardct::Error),
...
impl From<crate::vendor::jxl_vardct::Error> for Error {
    fn from(err: crate::vendor::jxl_vardct::Error) -> Self {
        Self::VarDct(err)
    }
}
...
impl Error {
    ...
    pub fn unexpected_eof(&self) -> bool {
        let bitstream_err = match self {
            ...
            | Self::VarDct(crate::vendor::jxl_vardct::Error::Bitstream(b))
            | Self::VarDct(crate::vendor::jxl_vardct::Error::Decoder(
                jxl_coding::Error::Bitstream(b),
            ))
            | Self::VarDct(crate::vendor::jxl_vardct::Error::Modular(
                jxl_modular::Error::Bitstream(b),
            ))
            | Self::VarDct(crate::vendor::jxl_vardct::Error::Modular(
                jxl_modular::Error::Decoder(jxl_coding::Error::Bitstream(b)),
            )) => b,
            _ => return false,
        };
