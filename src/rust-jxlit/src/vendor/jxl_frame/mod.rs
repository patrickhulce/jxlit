...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-frame/src/lib.rs
...
use crate::vendor::jxl_frame::data::*;
...
impl Frame {
    ...
    pub fn pass_group_bitstream(
        ...
        Some(if self.toc.is_single_entry() {
            ...
            let bitstream = Bitstream::new(&group.bytes);
