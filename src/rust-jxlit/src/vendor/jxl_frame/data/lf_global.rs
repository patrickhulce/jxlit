...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-frame/src/data/lf_global.rs
// Copied as-is; only crate-path references changed.

use crate::vendor::jxl_vardct::{
...
use crate::vendor::jxl_frame::{FrameHeader, Result, header::Encoding};
...
impl<S: Sample> Bundle<LfGlobalParams<'_, '_>> for LfGlobal<S> {
    ...
    fn parse(bitstream: &mut Bitstream, params: LfGlobalParams) -> Result<Self> {
        ...
        let vardct = (header.encoding == crate::vendor::jxl_frame::header::Encoding::VarDct)
...
define_bundle! {
    #[derive(Debug)]
    pub struct LfGlobalVarDct error(crate::vendor::jxl_frame::Error) {
