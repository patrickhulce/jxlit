...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-frame/src/data/toc.rs
...
impl Bundle<&crate::vendor::jxl_frame::FrameHeader> for Toc {
    type Error = crate::vendor::jxl_frame::Error;

    fn parse(
        bitstream: &mut Bitstream,
        ctx: &crate::vendor::jxl_frame::FrameHeader,
    ) -> Result<Self> {
