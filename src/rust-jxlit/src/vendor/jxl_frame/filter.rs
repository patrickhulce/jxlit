...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-frame/src/filter.rs
// Copied as-is; only crate-path references changed.

use jxl_bitstream::Bitstream;
use jxl_oxide_common::Bundle;

use crate::vendor::jxl_frame::{Result, header::Encoding};
