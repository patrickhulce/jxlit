...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-vardct/src/lf.rs
...
use crate::vendor::jxl_vardct::Result;

define_bundle! {
    /// Dequantization information for each channel.
    #[derive(Debug)]
    pub struct LfChannelDequantization error(crate::vendor::jxl_vardct::Error) {
    ...
    #[derive(Debug)]
    pub struct Quantizer error(crate::vendor::jxl_vardct::Error) {
    ...
    #[derive(Debug)]
    pub struct LfChannelCorrelation error(crate::vendor::jxl_vardct::Error) {
        all_default: ty(Bool) default(true),
...
impl<Ctx> Bundle<Ctx> for HfBlockContext {
    type Error = crate::vendor::jxl_vardct::Error;

    fn parse(bitstream: &mut Bitstream, _: Ctx) -> crate::vendor::jxl_vardct::Result<Self> {
