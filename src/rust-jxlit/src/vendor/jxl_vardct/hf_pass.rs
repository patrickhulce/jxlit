...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-vardct/src/hf_pass.rs
...
pub struct HfPassParams<'a> {
    hf_block_ctx: &'a crate::vendor::jxl_vardct::HfBlockContext,
    num_hf_presets: u32,
}
...
/// passed as a parameter when [decoding HF coefficients][crate::vendor::jxl_vardct::write_hf_coeff].
#[derive(Debug)]
pub struct HfPass {
...
impl Bundle<HfPassParams<'_>> for HfPass {
    ...
    fn parse(
        ...
        params: HfPassParams<'_>,
    ) -> crate::vendor::jxl_vardct::Result<Self> {
        let HfPassParams {
            hf_block_ctx,
            num_hf_presets,
        } = params;
