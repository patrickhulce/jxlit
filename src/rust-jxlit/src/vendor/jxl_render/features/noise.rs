...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-render/src/features/noise.rs
// Copied as-is; only crate-path references changed.

use std::num::Wrapping;

use crate::vendor::jxl_frame::{FrameHeader, data::NoiseParameters};
