...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-render/src/features/upsampling.rs
...
use crate::vendor::jxl_render::util::PaddedGrid;
...
) -> crate::vendor::jxl_render::Result<Option<AlignedGrid<f32>>> {
...
fn upsample_inner<const K: usize, const NW: usize>(
    ...
    weights: &[f32; NW],
    tracker: Option<&AllocTracker>,
) -> crate::vendor::jxl_render::Result<AlignedGrid<f32>> {
