...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-render/src/blend.rs
// Copied as-is; only crate-path references changed.

use std::sync::Arc;

use crate::vendor::jxl_frame::{
    Frame,
...
use crate::vendor::jxl_render::{ImageWithRegion, Reference, Region, Result, image::ImageBuffer};
...
impl<'a> BlendParams<'a> {
    ...
    fn from_patch_blending_info(
        ...
        use crate::vendor::jxl_frame::data::PatchBlendMode;
...
fn source_and_alpha_from_blending_info(
    ...
    use crate::vendor::jxl_frame::header::BlendMode;
