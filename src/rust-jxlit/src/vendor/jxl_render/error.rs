...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-render/src/error.rs
...
pub enum Error {
    ...
    Frame(crate::vendor::jxl_frame::Error),
...
impl From<crate::vendor::jxl_frame::Error> for Error {
    fn from(err: crate::vendor::jxl_frame::Error) -> Self {
        Self::Frame(err)
    }
}
