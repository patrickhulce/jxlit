...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-render/src/modular.rs
...
use crate::vendor::jxl_render::{
    Error, ImageWithRegion, IndexedFrame, Region, RenderCache, Result, util,
};
        ...
        pool.scope(|scope| {
            ...
            pool.for_each_vec(
                ...
                |PassGroupJob {
                    ...
                    let result = &result;
                    let r = crate::vendor::jxl_frame::data::decode_pass_group_modular(
                        &mut bitstream,
                        frame_header,
                        global_ma_config,
                        pass_idx,
