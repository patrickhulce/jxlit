...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-render/src/vardct/transform_common.rs
...
pub unsafe fn transform_varblocks_inner(
    ...
    for (channel, (coeff, lf)) in coeff_out.iter_mut().zip(lf).enumerate() {
        ...
        crate::vendor::jxl_render::vardct::for_each_varblocks(
            block_info,
            shift,
            |VarblockInfo {
                 shifted_bx,
