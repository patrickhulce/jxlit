...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-render/src/vardct/mod.rs
            ...
            pool.scope(|scope| {
                ...
                for &mut (group_idx, ref mut grid_xyb, lf_group) in &mut it {
                    ...
                    scope.spawn(move |_| {
                        ...
                        let r = crate::vendor::jxl_frame::data::decode_pass_group(
                            &mut bitstream,
                            PassGroupParams {
                                frame_header,
                                lf_group,
