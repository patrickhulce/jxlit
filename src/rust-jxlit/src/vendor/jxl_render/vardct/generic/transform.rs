...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-render/src/vardct/generic/transform.rs
// Copied as-is; only crate-path references changed.

#![allow(dead_code)]
use crate::vendor::jxl_vardct::{BlockInfo, TransformType};
use jxl_grid::{MutableSubgrid, SharedSubgrid};
use jxl_modular::ChannelShift;

use crate::vendor::jxl_render::vardct::{
