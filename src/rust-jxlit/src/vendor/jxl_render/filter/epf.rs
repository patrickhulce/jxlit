...
// Source: https://github.com/tirr-c/jxl-oxide/blob/f8ae722ef2d6b782941c89517d19cfbf605c4a9d/crates/jxl-render/src/filter/epf.rs
// Copied as-is; only crate-path references changed.

use std::collections::HashMap;

use crate::vendor::jxl_frame::{FrameHeader, data::LfGroup, filter::EpfParams};
use jxl_grid::{AlignedGrid, MutableSubgrid, SharedSubgrid};
use jxl_modular::Sample;
use jxl_threadpool::JxlThreadPool;

use crate::vendor::jxl_render::{ImageWithRegion, Region, util};
...
pub fn apply_epf<S: Sample>(
    ...
    if iters == 1 || iters == 3 {
        ...
        for (idx, grid) in fb_scratch_arr.into_iter().enumerate() {
            ...
            fb_image.replace_channel(
                idx,
                crate::vendor::jxl_render::ImageBuffer::F32(grid),
                region,
            );
        }
    }
